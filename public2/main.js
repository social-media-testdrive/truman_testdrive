...
$(window).on("load", function () {
  ...
  isResearchVersion =
    $('meta[name="isResearchVersion"]').attr("content") === "true";

  const initialVoiceoverState =
    window.sessionStorage.getItem("enableVoiceovers");
  ...
  if (
    enableDataCollection &&
    !(!isResearchVersion && window.location.pathname === "/")
  ) {
  ...
  $(".modual.info_button").click(function () {
    ...
    document.getElementById("post_info_text_modual").innerHTML =
      $(this).data("info_text");
  });
  ...
  $(".cybertrans").on("click", async function (e) {
    if ($(this).hasClass("green")) {
      ...
      if (pathArray[2] === "accounts") {
        if (
          $("input[type=text], textarea[type=text]").filter(function () {
            return $(this).val() == "";
          }).length === 6 &&
          $('input[name="profilePhoto"]').val() === "avatar-icon.svg"
        ) {
  ...
  $(".cybertrans2").on("click", function (e) {
    if ($(this).hasClass("green")) {
      let pathArray = window.location.pathname.split("/");
  ...
  //Cyberbullying to Transition
  $(".ui.big.green.labeled.icon.button.cybertutorial").on("click", function () {
    let pathArray = window.location.pathname.split("/");
    window.location.href = "/tutorial/" + pathArray[2];
  });

  //Cyberbullying to Transition (blue button)
  $(".ui.big.blue.labeled.icon.button.cybertutorial").on("click", function () {
    let pathArray = window.location.pathname.split("/");
    window.location.href = "/tutorial/" + pathArray[2];
  });
  ...
  $(document).on(
    "click",
    ".ui.big.labeled.icon.button.cybersim.green",
    function () {
      let pathArray = window.location.pathname.split("/");
  ...
  $(document).on(
    "click",
    ".ui.big.labeled.icon.button.cybersim.blue",
    function () {
      let pathArray = window.location.pathname.split("/");
      window.location.href = "/sim/" + pathArray[2];
    }
  ...
  $(document).on(
    "click",
    ".ui.big.labeled.icon.button.cybersim1.green",
    function () {
      let pathArray = window.location.pathname.split("/");
  ...
  $(document).on(
    "click",
    ".ui.big.labeled.icon.button.privacytutorial.green",
    function () {
  ...
  $(document).on(
    "click",
    ".ui.big.labeled.icon.button.privacytrans2.green",
    function () {
  ...
  $(document).on(
    "click",
    ".ui.big.labeled.icon.button.privacyesptrans2.green",
    function () {
      // Special Case: When a user clicks "Let's Continue" in the privacy module, but has not toggled any settings
      // prompt the user: Are you sure you do not want to try changing some privacy settings before continuing?
      if (!clickAction && $("#confirmContinueCheck").is(":hidden")) {
  ...
  $(document).on(
    "click",
    ".ui.big.labeled.icon.button.cybersim2.green",
    async function () {
      let pathArray = window.location.pathname.split("/");
      if (typeof customOnClickGreenContinue !== "undefined") {
        await customOnClickGreenContinue();
  ...
  //Cyberbullying to Transition
  $(".ui.big.green.labeled.icon.button.cybertrans_script").on(
    "click",
    function () {
  ...
  $(".ui.big.green.labeled.icon.button.cyber_script").on("click", function () {
  ...
  $(".ui.big.blue.labeled.icon.button.cyber_script").on("click", function () {
    console.log(window.location.pathname);
    let pathArray = window.location.pathname.split("/");
    console.log(pathArray);
    window.location.href = "/modual/" + pathArray[2];
  ...
  $(".ui.big.green.labeled.icon.button.prez_post_quiz").on(
    "click",
    function () {
  ...
  $(`#content .fluid.card .img img,
    img.ui.avatar.image,
    a.avatar.image img`).visibility({
    type: "image",
    offset: 0,
    onLoad: function (calculations) {
      $(`#content .fluid.card .img img,
            img.ui.avatar.image,
            a.avatar.image img`).visibility("refresh");
    },
  });
