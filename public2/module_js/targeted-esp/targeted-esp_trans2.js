...
function startIntro(){
  ...
  if($('.ui.big.labeled.icon.button').hasClass('green')){
    ...
    $.post("/interest", {
      ...
      if(currentSelect === "Comida"){
        window.location.href='/food/targeted-esp';
      } else if (currentSelect === "Deportes"){
        window.location.href='/sports/targeted-esp';
      } else if (currentSelect === "Videojuegos"){
        window.location.href='/gaming/targeted-esp';
      }
    });
  }
};
