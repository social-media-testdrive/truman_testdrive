function onPrint() {
    if ($('.results_print').hasClass('green')) {
        ...
        $(".insertPrint").append("<h4>¿Cuáles fueron las pistas que usas para identificar que eran post de estafa de phishing?</h4>");
        var responseOne = document.getElementById("digfoot_responseOne").value;
        $(".insertPrint").append(responseOne);

        $(".insertPrint").append("<br><h4>¿Por qué es importante protegerte de las estafas de phishing?</h4>");
