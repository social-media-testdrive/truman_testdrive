  ...
  if($('.ui.menu.notMobileView').is(":visible")){
    ...
    intro.setOptions({
      steps: [
        ...
        },
        {
          ...
          intro: "Notifications use bright colors that look urgent to grab your attention. It can make you feel like you have to go on the site to check what it’s about.",
          position: "right",
          scrollTo: "tooltip"
        },
        {
        ...
        },
        {
          ...
          intro: "Another feature that may keep you drawn into apps is autoplay, which starts playing another video as soon as you've finished the one you were watching.",
          position: "right",
          scrollTo: "tooltip"
        },
        {
          element: document.querySelectorAll('#step5')[0],
          intro: "This makes it tempting to keep watching, even if you have other things you want or need to do!",
          position: "right"
        },
        {
          element: document.querySelectorAll('#step6')[0],
          intro: "Also, in a real social media site, the timeline has no end! This keeps you engaged, but you could end up scrolling for hours, possibly spending more time than you had hoped to.",
          position: "right",
          scrollTo: "tooltip"
        }
    ...
    intro.setOptions({
      steps: [
        {
          element: document.querySelectorAll('#step0')[0],
          intro: "Have you ever had notifications buzz on your phone or seen them pop up on your phone's home screen?",
          position: "right",
          scrollTo: 'tooltip'
        },
        {
          element: document.querySelectorAll('#notificationstepsMobile')[0],
          intro: "Notifications use bright colors that look urgent to grab your attention. It can make you feel like you have to go on the app to check what it’s about.",
          position: "right",
          scrollTo: "tooltip"
        },
        {
