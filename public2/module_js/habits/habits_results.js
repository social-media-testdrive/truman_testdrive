...
function onPrint() {
    if ($('.results_print').hasClass('green')) {
        ...
        $(".insertPrint").append("<h4>How many of these attention-grabbing design features did you notice?</h4>");
        ...
        $(".insertPrint").append("<br><br><h4>What did you do when you saw an advertisement or a sponsored post?</h4>");
        $(".checkTwo").clone().removeClass('reflectionPromptSegment').appendTo(".insertPrint");

        $(".insertPrint").append("<br><h4>Why is it important to build healthy social media habits?</h4>");
