...
if(enableTeacherDashboard){
  ...
  app.get('/downloadReflectionResponses/:classId/:modName', passportConfig.isAuthenticated, csrfProtection, addCsrf, classController.downloadClassReflectionResponses);
