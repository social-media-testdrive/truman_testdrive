...
function setLinks(currentPage) {
    ...
    if(section === 'challenge') {
        ...
        if(currentPage === 'intro') {
            ...
            nextlink = '/course-player?module=romance&section=concepts&page=objectives';
        }
    } else if(section === 'concepts') {
        ...
        if(currentPage === 'objectives') {
            backlink = '/course-player?module=romance&section=consequences&page=objectives';
            nextlink = baseurl + 'types';
        } else if(currentPage === 'types') {
            // pause video
            backlink = baseurl + 'objectives';
        ...
        if(currentPage === 'objectives') {
            backlink = '/course-player?module=romance&section=requests&page=objectives';
            nextlink = baseurl + 'video';
        } 
        ...
        nextlink = '/course-player?module=romance&section=reporting&page=intro';
    }
}
        ...
        if(currentPage === 'objectives') {
            ...
            backlink = baseurl + 'quiz';
            nextlink = '/course-player?module=romance&section=practice&page=objectives';
        }
    } else if(section === 'practice') {
        ...
        if(currentPage === 'intro') {
            backlink = '/course-player?module=romance&section=practice&page=objectives';
            nextlink = baseurl + 'quiz'; 
        } else if(currentPage === 'quiz') {            
            backlink = baseurl + 'intro';
            nextlink = baseurl + 'badge';
