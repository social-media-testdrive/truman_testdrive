  ...
  if (!mute) {
    ...
    if (userInteracted) {
      ...
      var buttonText = document.querySelector(
        "#play-pause-audio span.toggle-text"
      );
      ...
      console.warn(
        "User has not interacted with the webpage yet. Cannot autoplay audio."
      );
    }
  }
}
...
function setupPractice() {
  ...
  intro2
      ...
      steps: [
        {
          ...
          position: "auto",
          intro:
            "This is your email inbox. Here you will find all the emails you've received.<br><br>Click the 'Next' button below to continue. <br><img src='/images/chat-head.png' alt='age intrepid profile picture' width='125px' style='display: block; margin: 0 auto;margin-top:20px;'>",
        },
        {
    ...
    .onchange(function () {
      //intro.js built in onchange function
...
function showEmail(index) {
  ...
  var openEmailContainer = $("<div>", {
    class: "openEmailContainer",
    id: "openEmail-" + iCurrentEmail,
  });
  ...
  deleteButton.append(
    $("<i>", { class: "trash alternate outline large icon" })
  );
  ...
  var inboxLabel = $("<div>", { class: "ui label", id: "inboxLabel" }).text(
    "Inbox"
  );
  ...
  var openDateHeader = $("<div>", { class: "ui right floated header" }).append(
    openDate
  );
  ...
  emailSegment.append($("<div>", { class: "ui horizontal divider" }));
  emailSegment.append(
    $("<div>", { class: "ui icon message" }).append(
  ...
  if (openEmailTutorialDone === false) {
    var closeEmailAnimation = $("<div>")
      .addClass("showReturnToInboxAnimation hidden")
        ...
        steps: [
          {
            ...
            element: document.querySelector(
              ".openEmailContainer .ui.padded.segment"
            ),
            position: "right",
            intro:
              "An opened email reveals the sender's information and message content. From here you can reply, report, block, or delete it. Let's explore these options. <br><img src='/images/chat-head.png' alt='age intrepid profile picture' width='125px' style='display: block; margin: 0 auto;margin-top:20px;'>",
          },
          {
            element: document.querySelector(".left.arrow.big.icon"),
            position: "right",
            intro:
              "<strong>Return Button</strong><br><br>This button takes you back to your inbox home page.",
          },
          {
            element: document.querySelector("#report"),
            position: "right",
            intro:
              "<strong>Report Button</strong><br><br>By reporting an email you're helping to protect not only yourself but also others from potential scams or cyberattacks.",
          },
          {
            element: document.querySelector("#block"),
            position: "right",
            intro:
              "<strong>Block Button</strong><br><br>If you're constantly receiving annoying emails or spam from a particular sender, you can use this function to prevent them from bothering you.",
          },
          {
            element: document.querySelector("#delete"),
            position: "right",
            intro:
              "<strong>Delete Button</strong><br><br>Deleting an email is like throwing away junk mail from your physical mailbox.",
          },
          {
            element: document.querySelector("#reply"),
            position: "right",
            intro:
              "<strong>Reply Button</strong><br><br>Allows you to send back a message in response.",
          },
          {
            myBeforeChangeFunction: function () {
              $(".openEmailContainer").css("pointer-events", "auto");
            ...
            position: "right",
            intro:
              "This concludes the tutorial for the email inbox. You now know everything you need to know to begin managing your emails and dealing with spam.<br><br>Click the top left arrow button to return to your inbox and begin exploring.<br><img src='/images/chat-head.png' alt='age intrepid profile picture' width='125px' style='display: block; margin: 0 auto;margin-top:20px;'>",
          },
        ],
        hidePrev: true,
        hideNext: true,
    ...
    actions: [
      ...
      },
      {
        ...
        click: function () {
          ...
          $(".warning-button").transition("pulsating looping");
        },
      },
    ],
...
function linkClick() {
  ...
  $.modal({
    ...
    closeIcon: true,
    content:
      "It's best not to click on links from emails. Navigating to the website yourself using a browser is always safer.",
    actions: [
      {
        text: "Got it",
        class: "blue big",
